(function ($) {
   ...
   $(document).ready(function () {
      ...
      function readURL(input, _this) {
         if (input.files && input.files[0]) {
            ...
            if (input.files[0].size > 5242880) {
               alert("The file selected is too large");
               return;
            }
      ...
      $('.field-group input[type="file"]').on("change", function () {
         var _this = $(this);
         readURL(this, _this);
      });
      ...
      if ($("#editor").length) {
         ...
         var syncHtml = debounce(function () {
            ...
            $("#company_description").val(contents);
      ...
      $(".filter-box").each(function () {
         $('.field-check input[type="checkbox"]').change(function () {
            if ($(this).is(":checked")) {
               ...
               $('.field-check input[type="checkbox"]').not(this).is(":checked")
            ) {
               $(this).parents("form").find(".clear-filter").addClass("open");
            } else if (
      ...
      $(".service_image_preview").on("mouseover", function () {
